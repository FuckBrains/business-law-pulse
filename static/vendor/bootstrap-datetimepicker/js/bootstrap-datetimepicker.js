...
!function ($) {
	...
	Datetimepicker.prototype = {
		...
		fill: function () {
            ...
            if (this.language=='zh-CN') {
                this.picker.find('.datetimepicker-days thead th:eq(1)').text(year + ' 年 ' + dates[this.language].months[month] + ' 月');
            } else {
			...
			if (this.formatViewType == "time") {
                ...
                if (this.language=='zh-CN') {
                    this.picker.find('.datetimepicker-hours thead th:eq(1)').text(year + ' 年 ' + dates[this.language].months[month] + ' 月 ' + dayMonth + ' 日');
                    this.picker.find('.datetimepicker-minutes thead th:eq(1)').text(year + ' 年 ' + dates[this.language].months[month] + ' 月 ' + dayMonth + ' 日');
                } else {
			...
			for (var i = 0; i < 60; i += this.minuteStep) {
				...
				if (this.showMeridian && dates[this.language].meridiem.length == 2) {
					...
					txt = i + ':00';
					//html.push('<span class="hour'+clsName+'">'+txt+'</span>');
                    var n = Math.ceil(60/this.minuteStep);
                    if (n % 5 == 0) {
                        html.push('<span class="minute' + clsName + '" style="width:18%;">' + hours + ':' + (i < 10 ? '0' + i : i) + '</span>');
                    } else if (n % 4 == 0) {
                        html.push('<span class="minute' + clsName + '" style="width:23%;">' + hours + ':' + (i < 10 ? '0' + i : i) + '</span>');
                    } else if (n % 3 == 0) {
                        html.push('<span class="minute' + clsName + '" style="width:31.33333333%;">' + hours + ':' + (i < 10 ? '0' + i : i) + '</span>');
                    } else if (n % 2 == 0) {
                        html.push('<span class="minute' + clsName + '" style="width:48%;">' + hours + ':' + (i < 10 ? '0' + i : i) + '</span>');
                    } else {
                        html.push('<span class="minute' + clsName + '" style="width:23%;">' + hours + ':' + (i < 10 ? '0' + i : i) + '</span>');
                    }
				}
			...
			var months = this.picker.find('.datetimepicker-months')
				.find('th:eq(1)')
				.text(year + (this.language == 'zh-CN' ? ' 年':''))
				.end()
			...
			var yearCont = this.picker.find('.datetimepicker-years')
				.find('th:eq(1)')
				.text(year + ' - ' + (year + 9) + (this.language == 'zh-CN' ? ' 年':''))
				.end()
				.find('td');
			year -= 1;
			for (var i = -1; i < 11; i++) {
	...
	DPGlobal.template = '<div class="datetimepicker">' +
		...
		'<table class=" table-condensed" style="width:240px;">' +
