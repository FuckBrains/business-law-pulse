...
define([
    ...
    'text!pages/www/pc/firm/ejs/detail.html',
    'text!pages/www/pc/firm/ejs/recent_lawyers.html',
    ...
    self.load_firm_recent_stats = function() {
        CORE.ajax.post({
            ...
            success: function(result) {
                ...
                $('.recent-lawyer-list').html(new EJS({ text: ejs_recent_lawyers }).render({ lawyers: result.data.lawyers }));
            }
        });
    };
    ...
    self.load_firm_feedback = function() {
        CORE.ajax.post({
            ...
            success: function(result) {
                var ejs_html = new EJS({ text: ejs_feedbacks }).render({ feedbacks: result.data.feedbacks });
                $('.feedback-list').html(ejs_html);
            }
        });
    };
        ...
        self.load_config(function() {
            CORE.ajax.post({
                ...
                success: function(result) {
                    ...
                    $('.site-main').html(new EJS({ text: ejs_detail }).render({
