...
CONST = {
    ...
    'domain': {
        'default': 'businesslawpulse.dev',
        'oss': 'oss.businesslawpulse.dev',
        'api': 'api.businesslawpulse.dev',
        'www': 'www.businesslawpulse.dev',
    },
    ...
    'static': {
        ...
        'url': 'http://oss.businesslawpulse.dev/static/',
        'cache': '1.0.0',
    },

    'media': {
        'base': os.path.join(ROOT, 'media'),
        'url': 'http://oss.businesslawpulse.dev/media/',
