...
CONST.update({
    ...
    'mongo': {
        'default': { 'db': 'blp_default', 'host': 'localhost', 'port': 20000, 'username': 'blp', 'password': 'blp', 'maxsize': 50 },
        'primary': { 'db': 'blp_default', 'host': 'localhost', 'port': 20000, 'username': 'blp', 'password': 'blp', 'maxsize': 50 },
    },
